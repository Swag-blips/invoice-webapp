    ...
    <>
      <div className="flex items-start justify-between">
        <div className="flex flex-col md:gap-2 ">
          ...
          <p className="font-medium text-sm text-left text-primary-text">
            {invoice?.description}
          </p>
          <div className="md:hidden mt-5 text-primary-text tracking-[-0.1px] text-sm font-medium flex-col text-left ">
        ...
        <div className="md:flex  hidden text-primary-text tracking-[-0.1px] text-sm font-medium flex-col  text-right ">
          <p>{invoice?.senderAddress.street}</p>
          <p>{invoice?.senderAddress.city}</p>
          <p>{invoice?.senderAddress.postCode}</p>
          <p>{invoice?.senderAddress.country}</p>
      ...
      <div className="flex mt-7 md:mt-0 items-start gap-16 md:gap-[117px]">
        <div className="flex flex-col justify-center gap-8">
          ...
          <div className=" flex flex-col gap-2">
            <p className="text-primary-text text-sm font-medium">Payment due</p>
            <p className="font-bold text-[#0C0E16] text-[15px] tracking-tight">
        ...
        <div>
          <p className="text-primary-text text-sm font-medium">Bill To</p>
          <p className="font-bold mt-[13px] text-[#0C0E16] text-[15px] tracking-tight">
            {invoice?.clientName}
          </p>
          <div className="flex mt-2 text-primary-text tracking-[-0.1px] text-sm font-medium flex-col  text-left ">
