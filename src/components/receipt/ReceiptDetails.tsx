    ...
    <>
      <div className="flex items-start justify-between">
        <div className="flex flex-col md:gap-2 ">
          <p className="text-[#0C0E16] text-base dark:text-white font-bold tracking-tight">
      ...
      <div className="flex mt-7 md:mt-0 items-start gap-16 md:gap-[117px]">
        <div className="flex flex-col justify-center gap-8">
          <div className=" flex flex-col gap-2">
            ...
            <p className="font-bold dark:text-white text-[#0C0E16] text-base tracking-tight">
        ...
        <div>
          ...
          <p className="font-bold mt-[13px] dark:text-white text-[#0C0E16] text-base tracking-tight">
            {invoice?.clientName}
          </p>
